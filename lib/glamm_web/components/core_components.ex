defmodule GlammWeb.CoreComponents do
  @moduledoc """
  ...
  def back(assigns) do
    ...
    <div class="mt-3">
      <.link
        navigate={@navigate}
        class="text-sm font-semibold leading-3 text-zinc-900 hover:text-zinc-700"
      >
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GlammWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GlammWeb.Gettext, "errors", msg, opts)
    end
  end
