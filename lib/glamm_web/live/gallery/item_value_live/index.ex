defmodule GlammWeb.Gallery.ItemValueLive.Index do
  ...
  def mount(_params, _session, socket) do
    socket =
      socket
      |> assign(:total_item_value, Gallery.length_gal_item_value())
      |> stream(:gal_item_value, Gallery.list_gal_item_value())
